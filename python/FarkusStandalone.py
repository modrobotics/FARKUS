...
import FarkusStandaloneModuleManager
...
class FarkusStandalone():
	...
	def __init__(self, gui):
		...
		self.standaloneModuleManager = FarkusStandaloneModuleManager.FarkusStandaloneModuleManager();
	...
	def setStandaloneModuleManager(self, manager):
		self.moduleManager = manager
	
	def getStandaloneModuleManager(self):
		return self.moduleManager
